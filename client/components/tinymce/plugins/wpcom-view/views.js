...
export const components = mapValues( views, view => {
...
export const emitters = values( views ).filter( view => view instanceof EventEmitter );

export const setMarkers = function( content ) {
...
export const isEditable = function( type ) {
	return !! ( views[ type ] && views[ type ].edit );
};

export const edit = function( type, editor, content ) {
