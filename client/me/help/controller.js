...
export const loggedOut = function( context, next ) {
...
export const help = function( context ) {
...
export const courses = function( context ) {
	const basePath = route.sectionify( context.path );
...
export const contact = function( context ) {
	const basePath = route.sectionify( context.path );
