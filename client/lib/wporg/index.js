...
export const fetchPluginInformation = function( pluginSlug, callback ) {
	var baseUrl,
		query = {
...
export const fetchPluginsList = function( options, callback ) {
	var payload;
	// default variables;
...
export const fetchThemeInformation = function( themeId ) {
	const query = {
...
export const fetchThemesList = function( options = {} ) {
