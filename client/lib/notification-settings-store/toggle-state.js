export const wpcom = function(state, source, stream, setting) {
    return state.updateIn( [ 'settings', 'dirty', 'wpcom', setting ], value => ! value );
};

export const other = function(state, source, stream, setting) {
    if ( isNaN( stream ) ) {
...
export const blog = function(state, source, stream, setting) {
