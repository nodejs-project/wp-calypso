...
export const plans = function( context ) {
...
export const features = function( context ) {
...
export const redirectToCheckout = function( context ) {
...
export const redirectToPlans = function( context ) {
