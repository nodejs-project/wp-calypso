...
export const checkout = function( context ) {
...
export const sitelessCheckout = function( context ) {
	const Checkout = require( './checkout' ),
		CheckoutData = require( 'components/data/checkout' ),
		CartData = require( 'components/data/cart' ),
		SecondaryCart = require( './cart/secondary-cart' );
...
export const checkoutThankYou = function( context ) {
...
export const gsuiteNudge = function( context ) {
