...
export const editLinkForPage = function( page, site ) {
...
export const statsLinkForPage = function( page, site ) {
	if ( ! ( page && page.ID ) || ! ( site && site.ID ) ) {
		return null;
	}
...
export const isFrontPage = function( page, site ) {
...
export const sortPagesHierarchically = function( pages ) {
