...
export const resetFirstView = function( context ) {
	context.store.dispatch( savePreference( 'firstViewHistory', [] ) );
};

export const redirectToDefaultSitePage = function( context, next ) {
...
export const insights = function( context ) {
...
export const overview = function( context, next ) {
...
export const site = function( context, next ) {
	let siteId = context.params.site_id;
...
export const summary = function( context, next ) {
	let siteId = context.params.site_id;
	const siteFragment = route.getSiteFragment( context.path );
	const queryOptions = context.query;
...
export const post = function( context ) {
	let siteId = context.params.site_id;
...
export const follows = function( context ) {
	let siteId = context.params.site_id;
	const FollowList = require( 'lib/follow-list' );
...
export const activityLog = function( context ) {
